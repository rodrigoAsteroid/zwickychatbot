        ...
        <div className="flex-shrink-0 w-6 h-6 mt-1 rounded-lg flex items-center justify-center">
          ...
          >
            <g clipPath="url(#clip0_5385_11776)">
              ...
              <path
                d="M12.4375 33.5V32.0625C12.4375 26.5051 16.9426 22 22.5 22C28.0574 22 32.5625 26.5051 32.5625 32.0625V33.5"
                stroke="#2E223B"
                strokeWidth="2.15625"
                strokeLinecap="round"
              ...
              />
              <path
                d="M22.5 22C25.6756 22 28.25 19.4256 28.25 16.25C28.25 13.0744 25.6756 10.5 22.5 10.5C19.3244 10.5 16.75 13.0744 16.75 16.25C16.75 19.4256 19.3244 22 22.5 22Z"
                stroke="#2E223B"
                strokeWidth="2.15625"
                strokeLinecap="round"
                strokeLinejoin="round"
